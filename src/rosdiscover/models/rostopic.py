...
def rostopic(c: NodeContext) -> None:
    ...
    p.add_argument('-r', dest='rate', type=int)
    ...
    p.add_argument('-c', dest='clear')
    p.add_argument('-b', type=str, dest='bag')
    p.add_argument('-p', action='store_true', dest='print_friendly')
    p.add_argument('-w', type=int, dest='width_fixed')
    p.add_argument('--nostr', action='store_true')
    p.add_argument('--noarr', action='store_true')
    p.add_argument('-n', type=int, dest='count')
    p.add_argument("topic", type=str)
