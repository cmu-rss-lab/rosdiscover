...
import roswire
from roswire.proxy.roslaunch.reader import ROS1LaunchFileReader
from roswire.ros2.reader import ROS2LaunchFileReader
...
class Interpreter:
    ...
    def launch(self, filename: str) -> None:
        ...
        if self.app.description.distribution.ros == ROSVersion.ROS1:
            reader = ROS1LaunchFileReader.for_app_instance(self.app)
        else:
            reader = ROS2LaunchFileReader.for_app_instance(self.app)
